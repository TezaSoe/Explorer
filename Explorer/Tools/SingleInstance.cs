...
namespace Explorer.Tools
{
    internal enum WM
        ...
        {
            public delegate void SignalCommand(IList<string> args);

            static SignalCommand signalCommandAction;
            ...
            public static bool InitializeAsFirstInstance(string uniqueName, SignalCommand command)
            {
                signalCommandAction = command;
            ...
            private class IPCRemoteService : MarshalByRefObject
            {
                ...
                {
                    //Program.MainForm.ProcessCommandLine(args);
                    if (signalCommandAction != null)
                        signalCommandAction(args);
                }
